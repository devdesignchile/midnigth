...
class Venue(models.Model):
    ...
    highlights_1 = models.CharField(max_length=30, blank=True)
    highlights_2 = models.CharField(max_length=30, blank=True)
    highlights_3 = models.CharField(max_length=30, blank=True)
    ...
    vgt_promos_1 = models.CharField(max_length=50, blank=True, null=True)
    vgt_promos_2 = models.CharField(max_length=50, blank=True, null=True)
    vgt_promos_3 = models.CharField(max_length=50, blank=True, null=True)
